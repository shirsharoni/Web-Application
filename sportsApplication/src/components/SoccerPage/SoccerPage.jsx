                    ...
                    <div className="interview-info" > 
                      ...
                      <span className="step-icon">  
                        ...
                        <div className="text-container" >
                          ...
                          {new Date(data.steps[selectedPlayerIndex].time_scheduled).toLocaleString('en-US', {
                            weekday: 'long',
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric',
                        ...
                        </div> ) : (<span className="p-interview">Not scheduled yet</span>)}
                        </span><br/>
                        <span className="step-header">
                          <img
                          alt=""
                        ...
                        <div className="where" style={{display:"inline-flex" }}>
                          ...
                          {data.steps[selectedPlayerIndex].type === "Phone Interview" && (
                            <span className="p-interview">Phone call</span>)}
                          {data.steps[selectedPlayerIndex].type === "Video Interview" && (
                          ...
                          data.steps[selectedPlayerIndex].type !== "Video Interview" && (
                            ...
                            >
                              <span style={{ padding: ".0rem .5rem", fontSize: "1.75rem" }}>
                            ...
                            >
                              <span style={{ padding: ".20rem .5rem", fontSize: "1.70rem" }}>
                                <button type="button" className="btn btn-link">
